...
// Allow youtube | mp3 | mp4 | game
export type HostPayload = z.infer<typeof hostSchema> & { contentType: 'youtube' | 'mp3' | 'mp4' | 'game' };
 ...
 */
export function detectContentType(url: string): 'youtube' | 'mp3' | 'mp4' | 'game' | null {
